            ...
            <div class="note-card">
                <form action="{{route('updateNote', ['id' => $note->id])}}" method="POST">
                    ...
                    <div>
                        ...
                        <input value="{{$note->title}}" placeholder="Title" class="input-t" id="title" name="title" maxlength="50" type="text"/><br>
                    </div><br>
                    <div class="form-group">
                        <label for="description"></label>
                        <input value="{{$note->description}}" placeholder="Description" class="input-dc" id="description" name="description" maxlength="100" type="text"><br>
                    </div>
                    <div class="form-group">
                        <label for="content"></label>
                        <input value="{{$note->content}}" placeholder="Content" class="input-dc" id="content" name="content" maxlength="10000" type="text" required><br>
                    </div>
                    <br>
