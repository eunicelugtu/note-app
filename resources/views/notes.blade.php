    ...
    <div class="note-container">
        ...
        <form action="{{route('createNote')}}" method="GET">
            <button type="submit" class="button-add">
                <span class="button-add__text">add note</span>
                <span class="button-add__icon"><svg class="fill-white" viewBox="0 0 0.6 0.6" height="20" width="20"><path d="M.325.275H.55v.05H.325V.55h-.05V.325H.05v-.05h.225V.05h.05z" fill-rule="evenodd"></path></svg></span>
            </button>
        </form>
        ...
        @else
            <div class="note-grid">
                ...
                <div class="note-card">
                    ...
                    <p class="content">{{ $note->excerpt() }}</p>
